"""
Django settings for finmako project.
...
SECRET_KEY = env('SECRET_KEY', default='knpyCiBXHiRoKXRMOvxcJgxvNuECiGDvMmbRgkko')
...
WSGI_APPLICATION = 'finmako.wsgi.application'
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'finmako_language'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'finmako',
    'DESCRIPTION': 'Finance website with calculators to support decision making.',
    'VERSION': '0.1.0',
...
WAGTAIL_SITE_NAME = 'finmako Content'
...
PROJECT_METADATA = {
    'NAME': gettext_lazy('finmako'),
    'URL': 'http://finmako.com',
    'DESCRIPTION': gettext_lazy("Finance website with calculators to support decision making."),
...
LOGGING = {
    ...
    'loggers': {
        ...
        'finmako': {
            'handlers': ['console'],
            'level': env('FINMAKO_LOG_LEVEL', default='INFO'),
        }
    }
}
